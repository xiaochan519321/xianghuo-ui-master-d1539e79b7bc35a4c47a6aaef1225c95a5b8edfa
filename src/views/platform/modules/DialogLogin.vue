    ...
    <div class='dialog-private-login'>
        <el-dialog
            ...
            >
                ...
                <el-form-item>
                    <el-select v-model="loginForm.platformId" placeholder="请选择">
                        <el-option
                ...
                <el-form-item prop="code">
                    <div class="flex mt10">
                        ...
                        <div class="msg-box"  @click="handleSend" v-loading="codeLoading" element-loading-customClass="code-loading-icon">
...
<script>
import { getSendCode, platformLogin } from '@/api/platform'
...
export default {
    ...
    methods: {
        async handleSend () {
            ...
            try {
                const { data } = await getSendCode({phone: this.loginForm.mobile, platformId: this.loginForm.platformId})
        ...
        handleLogin () {
            this.$refs.loginForm.validate(async (valid) => {
                if (valid) {
                    ...
                    try {
                        const { data } = await platformLogin(this.loginForm)
