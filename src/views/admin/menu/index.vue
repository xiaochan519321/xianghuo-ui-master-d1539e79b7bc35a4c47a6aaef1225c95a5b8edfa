<template>
  <basic-container>
    <div class="avue-crud">
      <el-form :inline="true">
        <el-form-item>
          <el-button v-if="permissions.sys_menu_add && siteConfig.id == 1" icon="el-icon-plus" type="primary"
      ...
      <el-table
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" v-if="siteConfig.id == 1">
          <template slot-scope="scope">
            <el-button
              size="small"
              type="text"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(['permissions','siteConfig']),
    },
    methods: {
